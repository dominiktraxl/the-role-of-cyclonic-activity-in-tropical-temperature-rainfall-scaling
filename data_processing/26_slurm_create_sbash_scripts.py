...
# slurm folders
if cg_N is not None:
    slurmSBFiles = f'gl_cg_{cg_N}_grad_stats{tcfstr}_parts_SBFiles/'
    slurmOUT = f'gl_cg_{cg_N}_grad_stats{tcfstr}_parts_OUTPUT/'
    slurmSTDERR = f'gl_cg_{cg_N}_grad_stats{tcfstr}_parts_STDERR/'
else:
    slurmSBFiles = f'gl_grad_stats{tcfstr}_parts_SBFiles/'
    slurmOUT = f'gl_grad_stats{tcfstr}_parts_OUTPUT/'
    slurmSTDERR = f'gl_grad_stats{tcfstr}_parts_STDERR/'
...
def _generate_sbatch_commandfile(locs, sbfile):
    ...
    if cg_N is not None:
        f.write(
            f"srun 14b_slurm_create_gl_grad_stats.py {tcestr}"
